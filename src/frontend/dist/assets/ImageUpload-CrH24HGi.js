import { c as createLucideIcon, r as reactExports, j as jsxRuntimeExports, i as composeRefs, R as React2, k as useComposedRefs, l as reactDomExports, m as React, n as ReactDOM, C as ChevronDown, f as cn, X, B as Button } from "./index-DuMvlbDW.js";
import { E as ExternalBlob } from "./backend-B-zt_gHz.js";
/**
...
function ImageUpload({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: cn("relative", className), children: [
    preview ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative aspect-[3/4] rounded-xl overflow-hidden border border-border", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "img",
        {
          src: preview,
      ...
      "button",
      {
        ...
        className: cn(
          ...
          isDragging ? "border-primary bg-primary/5" : "border-border hover:border-primary/60 hover:bg-muted/50"
        ),
        "data-ocid": "image_upload.dropzone",
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-12 h-12 rounded-full bg-muted flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Image, { className: "w-6 h-6 text-muted-foreground" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center px-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-medium text-foreground", children: "Drop image here" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-1", children: "or click to browse" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            Button,
            {
